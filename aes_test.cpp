...
/* the mpz library can be used to handle large numbers during operations. this is an attempt in resolving
our 'out of memory' issue whenever using the global values of q,p, g : */
